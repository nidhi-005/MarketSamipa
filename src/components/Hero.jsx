...
export default function Hero({ query, setQuery, easyMode, fz, filteredShops, voiceNote, setVoiceNote }) {
  ...
  return (
    <section style={{ background: `linear-gradient(160deg, ${TOKENS.night} 0%, ${TOKENS.royal} 100%)`, padding: "60px 20px 50px" }}>
      <div style={{ maxWidth: 780, margin: "0 auto", textAlign: "center" }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(199,154,43,0.14)", border: `1px solid ${TOKENS.gold}`, color: TOKENS.goldLight, padding: "6px 14px", borderRadius: 999, fontSize: 12.5, fontWeight: 700, marginBottom: 20 }}>
        ...
        <div style={{ background: TOKENS.ivory, borderRadius: 16, padding: 10, display: "flex", gap: 8, flexWrap: "wrap", boxShadow: "0 20px 40px -18px rgba(0,0,0,0.5)", maxWidth: 640, margin: "0 auto" }}>
          <button
          ...
          <div style={{ flex: "1 1 200px", display: "flex", alignItems: "center", gap: 8, padding: "8px 10px" }}>
          ...
          <button onClick={readResultsAloud} title="Read results aloud" style={{
